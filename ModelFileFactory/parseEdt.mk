...
JAVAINCLUDES = bin:src:lib/stanford-parser-2010-11-30.jar:lib/opennlp-tools-1.4.3.jar:lib/stanford-postagger-2008-09-28.jar:lib/jdom.jar
...
CLASSES = \
	src/edtProcessor/ParsingEdt.java 
...
run: classes
	mkdir -p $(OUTPUT)
	java -Xmx1024m -Xms1024m -classpath $(JFLAGS) edtProcessor/ParsingEdt ./EDTClinicalText/0.txt ./EDTClinicalText
...
################################################################################
#clean:
#	$(RM) src/edtProcessor/*.class
#	$(RM) bin/edtProcessor/*.class
#	$(RM) bin/utils/*.class
